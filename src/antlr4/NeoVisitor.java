...
public interface NeoVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link NeoParser#invTerm}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInvTerm(NeoParser.InvTermContext ctx);
	/**
	 * Visit a parse tree produced by {@link NeoParser#detTerm}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDetTerm(NeoParser.DetTermContext ctx);
	/**
