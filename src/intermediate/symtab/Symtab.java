    ...
    extends TreeMap<String, SymtabEntry>
{
    ...
    {
        SymtabEntry entry;
        if (name.charAt(0) == 'r')          entry = new RealSymtabEntry(name, this);
        else if (name.charAt(0) == 'm')     entry = new MatrixSymtabEntry(name, this);
        else                                entry = new FunctionSymtabEntry(name, this);
        put(name, entry);
